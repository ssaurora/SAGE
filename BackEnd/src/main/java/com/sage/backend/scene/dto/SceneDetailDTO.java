...
public class SceneDetailDTO {
    ...
    private SceneAuditSummaryDTO auditSummary;

    @JsonProperty("action_recommendation")
    private SceneActionRecommendationDTO actionRecommendation;

    @JsonProperty("session_projection")
    private SessionProjectionDTO sessionProjection;
    ...
    public SceneAuditSummaryDTO getAuditSummary() {
        return auditSummary;
    }

    public void setAuditSummary(SceneAuditSummaryDTO auditSummary) {
    ...
    public SessionProjectionDTO getSessionProjection() {
        return sessionProjection;
    }

    public void setSessionProjection(SessionProjectionDTO sessionProjection) {
